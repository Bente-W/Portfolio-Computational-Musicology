...
```{r}
plot2 <- ggplot(data = Comparison2, aes(x = valence, y = energy, color = category)) +
...
### “I won’t be a rock star. I’ll be a legend.” - Freddie Mercury. A legend he is and this is why. {data-commentary-width=400}
