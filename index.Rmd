...
plot3 <- ggplot(Comparison1, aes(x = danceability, y = track.popularity, color = valence, size = instrumentalness, key = track.name)) +
...
```{r}
plot2 <- ggplot(data = Comparison2, aes(x = valence, y = energy, color = category, key = track.name)) +
  geom_vline(xintercept = 0.5) +
  geom_hline(yintercept = 0.5) +
  geom_point(size = 3, alpha = 0.7) +
  labs(y = 'Energy', x = 'Valence', color = 'Category', key = 'Track name') +
