...
According to the clusters, some of the timbre levels should be very distinct between the three categories I plotted. For example, from most useful to less useful, level 4, 12, 3 and 1.
...
***
**Explanation**  
The most important feature to tell Freddie Mercury apart from Queen is timbre level 4, which shows the difference between the beginning and end of .... Outside of the timbre features, loudness, danceability and speechiness were most important.
...
...
***
**Explanation**  
In terms of timbre, the groups are quite distinguishable as you can see in the plot and in the former tab. What this exactly means is very hard to say. 
