...
### The most popular songs are danceable, happy and have sung lyrics. {data-commentary-width=500}
...
### Chromagram of a very atypical song by Queen (*Ming's Theme*) shows simplicity. {data-commentary-width=682}
...
I have also plotted *The Great Pretender* as a chromagram (can be seen on this page) and interestingly this was much more readable than original Queen and Freddie Mercury songs, just like *Ming's Theme*. In the chromagram you can clearly see that the song is in G major and modulates at around 2 minutes to G sharp major.

`r valueBox(42, icon = "fa-pencil", href="###details")`
...
### Queen songs tend to deviate from the clear structure used in popular music, unless Roger Taylor writes the song. {data-commentary-width=500}
```{r}
### different song
rhapsody <-
...
CarPlot <- bind_rows(
  ...
  labs(x = "", y = "", subtitle = "I'm in Love With My Car")
...
RhapsodyPlot <- bind_rows(
  ...
  facet_wrap(~type) +
  scale_fill_viridis_c(guide = "none") +
  labs(x = "", y = "", subtitle = "Bohemian Rhapsody") +
  theme_minimal() + 
  theme(plot.title = element_text(size = 11))
